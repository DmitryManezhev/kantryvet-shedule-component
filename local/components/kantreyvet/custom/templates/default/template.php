                    ...
                    <div class="staff-list-inner">
                        <div class="staff-list-inner__section-content">
                            ...
                            <div class="doctors-filters" style="margin-bottom: 20px;">
                                ...
                                <!-- Фильтр по услугам -->
                                <?php if ($arParams["SHOW_SERVICES_FILTER"] == "Y"):?>
                                    <div class="doctors-services-filter" style="margin-bottom: 15px;">
                                        <select class="form-control doctors-services-filter__select" id="servicesFilter">
                                            ...
                                            foreach ($arResult['SECTIONS'] as $arSection) {
                                                foreach ($arSection['ITEMS'] as $arDoctor) {
                                                    if (!empty($arDoctor['PROPERTY_LINK_SERVICES_VALUE'])) {
                                                        $services = is_array($arDoctor['PROPERTY_LINK_SERVICES_VALUE'])
                                                            ? $arDoctor['PROPERTY_LINK_SERVICES_VALUE']
                                                            : [$arDoctor['PROPERTY_LINK_SERVICES_VALUE']];
                                                        foreach ($services as $serviceId) {
                                                            $arServiceIds[$serviceId] = $serviceId;
                                                        }
                                                    }
                                                }
                                            }
                                            foreach ($arServiceIds as $serviceId):
                                                $serviceName = $arResult['SERVICES'][$serviceId]['NAME'] ?? $serviceId;
                                            ?>
                                                <option value="<?=htmlspecialcharsbx($serviceId)?>">
                                                    <?=htmlspecialcharsbx($serviceName)?>
                                                </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                ...
                                <!-- Фильтр по филиалам (точкам приёма) -->
                                    ...
                                    <div class="doctors-shops-filter">
                                        <select class="form-control doctors-shops-filter__select" id="shopsFilter">
                                            ...
                                            <?php foreach ($arResult["SHOPS"] as $arShop):?>
                                                <option value="<?=$arShop["ID"]?>" <?=($arParams["DEFAULT_SHOP_ID"] == $arShop["ID"] ? "selected" : "")?>>
                                                    <?=htmlspecialcharsbx($arShop["NAME"])?>
                                                </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                ...
                                <div class="staff-list-inner__section">
                                    ...
                                    <div class="staff-list-inner__list staff-list-inner__list--items-1 grid-list grid-list--items-1 <?= $listClasses ?>">
                                        <?php foreach ($arSection['ITEMS'] as $arItem): ?>
                                            ...
                                            $servicesIds = is_array($arItem['PROPERTY_LINK_SERVICES_VALUE'])
                                                ? $arItem['PROPERTY_LINK_SERVICES_VALUE']
                                                : [$arItem['PROPERTY_LINK_SERVICES_VALUE']];
                                            $shopsIds    = is_array($arItem['PROPERTY_SHOP_VALUE'])
                                                ? $arItem['PROPERTY_SHOP_VALUE']
                                                : [$arItem['PROPERTY_SHOP_VALUE']];
                                            ?>
                                            <div class="staff-list-inner__wrapper grid-list__item stroke-theme-parent-all colored_theme_hover_bg-block animate-arrow-hover grid-list-border-outer doctor-item"
                                                 ...
                                                 data-services="<?=htmlspecialcharsbx(implode(',', $servicesIds))?>"
                                                 data-shops="<?=htmlspecialcharsbx(implode(',', $shopsIds))?>"
                                                    ...
                                                    <div class="staff-list-inner__content-wrapper">
                                                        ...
                                                        <div class="staff-list-inner__bottom">
                                                            <div class="staff-list-inner__properties line-block line-block--40">
                                                                ...
                                                                <?php if ($arParams['SHOW_CONTACTS'] == 'Y' && $arItem['CONTACT_PROPERTIES']): ?>
                                                                ...
                                                                <?php if ($arItem['SOCIAL_PROPERTIES']): ?>
